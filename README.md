...
sf service-process retrieve -i 0SPxx0000008ABC -o devSandbox -d ./sp-artifacts
...
sf service-process retrieve -i 0SPxx0000008ABC -o devSandbox
...
3. Fork the repo, make your changes, add tests, and open a pull request.
4. Sign the [Contributor's License Agreement](https://cla.salesforce.com/sign-cla) when required.

This plugin is based on the [oclif](https://oclif.io) framework and the [Salesforce CLI plugin developer guide](https://developer.salesforce.com/docs/atlas.en-us.sfdx_cli_plugins.meta/sfdx_cli_plugins/cli_plugins_architecture_sf_cli.htm).
