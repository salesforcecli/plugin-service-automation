...
export class DeployWorkspace {
   ...
   */
  public static async extractZipToWorkspace(inputPath: string): Promise<DeployWorkspaceResult> {
   ...
   */
  public static async createZipFromWorkspace(workspacePath: string): Promise<{
    zipPath: string;
    cleanup: () => void;
  }> {
    const zip = new JSZip();
